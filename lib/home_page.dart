...
import 'package:major/openai_service.dart';
import 'package:major/pallete.dart';
import 'package:major/feature_box.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: BounceInDown(child: const Text('Bot')),
                ...
                children: [
                  ...
                  SlideInLeft(
                    ...
                    child: const FeatureBox(color: Pallete.secondSuggestionBoxColor,
                      headerText: 'Dall-E',
                      descriptionText: 'Get inspired and stay creative with your personal assistant powerwd by Dall-E',
                    ),
                  ),
                  SlideInLeft(
                    ...
                    child: const FeatureBox(color: Pallete.thirdSuggestionBoxColor,
                      ...
                      descriptionText: 'Get the best of both world voice assistant powered by Dall-E and ChatGPT',
                    ),
                  ),
      ...
      floatingActionButton: ZoomIn(
        ...
        child: FloatingActionButton(
          ...
          child:  Icon(speechToText.isListening ? Icons.mic : Icons.mic),
